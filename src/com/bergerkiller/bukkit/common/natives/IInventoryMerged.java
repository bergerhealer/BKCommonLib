 ...
 */
public class IInventoryMerged implements IInventory {
	private final IInventory[] inv;

	public IInventoryMerged(Inventory... inventories) {
	...
	public IInventoryMerged(IInventory... inventories) {
	...
	public static Inventory convert(Inventory... inventories) {
		if (inventories.length == 1) {
			...
			return new IInventoryMerged(inventories).getInventory();
		}
	}

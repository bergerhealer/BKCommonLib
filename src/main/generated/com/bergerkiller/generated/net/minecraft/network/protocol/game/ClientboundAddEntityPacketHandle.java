...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ClientboundAddEntityPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundAddEntityPacket")
public abstract class ClientboundAddEntityPacketHandle extends PacketHandle {
    /** @see ClientboundAddEntityPacketClass */
    public static final ClientboundAddEntityPacketClass T = Template.Class.create(ClientboundAddEntityPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    public com.bergerkiller.bukkit.common.entity.CommonEntityType getCommonEntityType() {
        if (T.opt_entityTypeId.isAvailable()) {
            ...
            EntityTypeHandle nmsType = T.opt_entityType.get(getRaw());
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ClientboundAddEntityPacket</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ClientboundAddEntityPacketClass extends Template.Class<ClientboundAddEntityPacketHandle> {
        public final Template.Field.Integer entityId = new Template.Field.Integer();
        @Template.Optional
        public final Template.Field<UUID> entityUUID = new Template.Field<UUID>();
        @Template.Optional
        public final Template.Field.Converted<EntityTypeHandle> opt_entityType = new Template.Field.Converted<EntityTypeHandle>();
        @Template.Optional
        ...
        public final Template.StaticMethod.Converted<ClientboundAddEntityPacketHandle> createNew = new Template.StaticMethod.Converted<ClientboundAddEntityPacketHandle>();

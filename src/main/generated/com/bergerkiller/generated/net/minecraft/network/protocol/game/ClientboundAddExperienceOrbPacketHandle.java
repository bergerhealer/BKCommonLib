...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ClientboundAddExperienceOrbPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.Optional
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundAddExperienceOrbPacket")
public abstract class ClientboundAddExperienceOrbPacketHandle extends PacketHandle {
    /** @see ClientboundAddExperienceOrbPacketClass */
    public static final ClientboundAddExperienceOrbPacketClass T = Template.Class.create(ClientboundAddExperienceOrbPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ClientboundAddExperienceOrbPacket</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ClientboundAddExperienceOrbPacketClass extends Template.Class<ClientboundAddExperienceOrbPacketHandle> {

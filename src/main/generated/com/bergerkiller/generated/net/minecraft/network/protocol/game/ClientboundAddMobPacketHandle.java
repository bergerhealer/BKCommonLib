...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ClientboundAddMobPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundAddMobPacket")
public abstract class ClientboundAddMobPacketHandle extends PacketHandle {
    /** @see ClientboundAddMobPacketClass */
    public static final ClientboundAddMobPacketClass T = Template.Class.create(ClientboundAddMobPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ClientboundAddMobPacket</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ClientboundAddMobPacketClass extends Template.Class<ClientboundAddMobPacketHandle> {
        ...
        public final Template.StaticMethod.Converted<ClientboundAddMobPacketHandle> createNew = new Template.StaticMethod.Converted<ClientboundAddMobPacketHandle>();

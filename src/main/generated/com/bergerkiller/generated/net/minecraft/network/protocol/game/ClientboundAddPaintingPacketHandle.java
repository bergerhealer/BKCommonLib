...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ClientboundAddPaintingPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundAddPaintingPacket")
public abstract class ClientboundAddPaintingPacketHandle extends PacketHandle {
    /** @see ClientboundAddPaintingPacketClass */
    public static final ClientboundAddPaintingPacketClass T = Template.Class.create(ClientboundAddPaintingPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ClientboundAddPaintingPacket</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ClientboundAddPaintingPacketClass extends Template.Class<ClientboundAddPaintingPacketHandle> {

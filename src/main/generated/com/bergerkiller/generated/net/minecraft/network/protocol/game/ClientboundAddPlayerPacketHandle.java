...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ClientboundAddPlayerPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundAddPlayerPacket")
public abstract class ClientboundAddPlayerPacketHandle extends PacketHandle {
    /** @see ClientboundAddPlayerPacketClass */
    public static final ClientboundAddPlayerPacketClass T = Template.Class.create(ClientboundAddPlayerPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ClientboundAddPlayerPacket</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ClientboundAddPlayerPacketClass extends Template.Class<ClientboundAddPlayerPacketHandle> {
        ...
        public final Template.StaticMethod.Converted<ClientboundAddPlayerPacketHandle> createNew = new Template.StaticMethod.Converted<ClientboundAddPlayerPacketHandle>();

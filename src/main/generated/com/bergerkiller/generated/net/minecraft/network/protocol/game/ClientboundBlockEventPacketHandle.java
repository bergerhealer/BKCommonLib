...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ClientboundBlockEventPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundBlockEventPacket")
public abstract class ClientboundBlockEventPacketHandle extends PacketHandle {
    /** @see ClientboundBlockEventPacketClass */
    public static final ClientboundBlockEventPacketClass T = Template.Class.create(ClientboundBlockEventPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ClientboundBlockEventPacket</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ClientboundBlockEventPacketClass extends Template.Class<ClientboundBlockEventPacketHandle> {

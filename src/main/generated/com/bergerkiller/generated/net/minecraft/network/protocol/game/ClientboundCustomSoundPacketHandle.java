...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ClientboundCustomSoundPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundCustomSoundPacket")
public abstract class ClientboundCustomSoundPacketHandle extends PacketHandle {
    /** @see ClientboundCustomSoundPacketClass */
    public static final ClientboundCustomSoundPacketClass T = Template.Class.create(ClientboundCustomSoundPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ClientboundCustomSoundPacket</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ClientboundCustomSoundPacketClass extends Template.Class<ClientboundCustomSoundPacketHandle> {
        ...
        public final Template.StaticMethod.Converted<ClientboundCustomSoundPacketHandle> createNew = new Template.StaticMethod.Converted<ClientboundCustomSoundPacketHandle>();

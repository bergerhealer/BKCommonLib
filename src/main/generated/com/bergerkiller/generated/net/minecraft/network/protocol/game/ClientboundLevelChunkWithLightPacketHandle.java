...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ClientboundLevelChunkWithLightPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundLevelChunkWithLightPacket")
public abstract class ClientboundLevelChunkWithLightPacketHandle extends PacketHandle {
    /** @see ClientboundLevelChunkWithLightPacketClass */
    public static final ClientboundLevelChunkWithLightPacketClass T = Template.Class.create(ClientboundLevelChunkWithLightPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ClientboundLevelChunkWithLightPacket</b>.

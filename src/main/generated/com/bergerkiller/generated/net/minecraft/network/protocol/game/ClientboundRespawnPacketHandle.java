...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ClientboundRespawnPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundRespawnPacket")
public abstract class ClientboundRespawnPacketHandle extends PacketHandle {
    /** @see ClientboundRespawnPacketClass */
    public static final ClientboundRespawnPacketClass T = Template.Class.create(ClientboundRespawnPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ClientboundRespawnPacket</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ClientboundRespawnPacketClass extends Template.Class<ClientboundRespawnPacketHandle> {
        @Template.Optional

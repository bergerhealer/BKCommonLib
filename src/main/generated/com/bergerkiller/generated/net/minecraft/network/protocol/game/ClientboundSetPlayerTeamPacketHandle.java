 ...
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundSetPlayerTeamPacket")
public abstract class ClientboundSetPlayerTeamPacketHandle extends PacketHandle {
    /** @see ClientboundSetPlayerTeamPacketClass */
    public static final ClientboundSetPlayerTeamPacketClass T = Template.Class.create(ClientboundSetPlayerTeamPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */

...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ClientboundSoundPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ClientboundSoundPacket")
public abstract class ClientboundSoundPacketHandle extends PacketHandle {
    /** @see ClientboundSoundPacketClass */
    public static final ClientboundSoundPacketClass T = Template.Class.create(ClientboundSoundPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ClientboundSoundPacket</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ClientboundSoundPacketClass extends Template.Class<ClientboundSoundPacketHandle> {

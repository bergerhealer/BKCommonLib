...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.PacketPlayInFlying</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.PacketPlayInFlying")
public abstract class PacketPlayInFlyingHandle extends PacketHandle {
    /** @see PacketPlayInFlyingClass */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.PacketPlayInFlying</b>.

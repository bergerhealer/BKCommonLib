...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.ServerboundMovePlayerPacket</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.network.protocol.game.ServerboundMovePlayerPacket")
public abstract class ServerboundMovePlayerPacketHandle extends PacketHandle {
    /** @see ServerboundMovePlayerPacketClass */
    public static final ServerboundMovePlayerPacketClass T = Template.Class.create(ServerboundMovePlayerPacketClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.ServerboundMovePlayerPacket</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ServerboundMovePlayerPacketClass extends Template.Class<ServerboundMovePlayerPacketHandle> {

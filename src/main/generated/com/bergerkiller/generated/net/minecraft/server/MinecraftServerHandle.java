...
public abstract class MinecraftServerHandle extends Template.Handle {
    ...
    public static final class MinecraftServerClass extends Template.Class<MinecraftServerHandle> {
        ...
        public final Template.Method<String> getLevelName = new Template.Method<String>();
        public final Template.Method<Integer> getTicksSinceUnixEpoch = new Template.Method<Integer>();

...
/**
 * Instance wrapper handle for type <b>net.minecraft.world.entity.Mob</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.world.entity.Mob")
public abstract class MobHandle extends LivingEntityHandle {
    /** @see MobClass */
    public static final MobClass T = Template.Class.create(MobClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.world.entity.Mob</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class MobClass extends Template.Class<MobHandle> {
        @Template.Optional

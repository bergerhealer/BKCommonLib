...
/**
 * Instance wrapper handle for type <b>net.minecraft.world.entity.decoration.ArmorStand</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.world.entity.decoration.ArmorStand")
public abstract class ArmorStandHandle extends LivingEntityHandle {
    /** @see ArmorStandClass */
    public static final ArmorStandClass T = Template.Class.create(ArmorStandClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.world.entity.decoration.ArmorStand</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ArmorStandClass extends Template.Class<ArmorStandHandle> {
        @Template.Optional

...
/**
 * Instance wrapper handle for type <b>net.minecraft.world.entity.item.ItemEntity</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.world.entity.item.ItemEntity")
public abstract class ItemEntityHandle extends EntityHandle {
    /** @see ItemEntityClass */
    public static final ItemEntityClass T = Template.Class.create(ItemEntityClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.world.entity.item.ItemEntity</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class ItemEntityClass extends Template.Class<ItemEntityHandle> {
        public final Template.Constructor.Converted<ItemEntityHandle> constr_world_x_y_z_itemstack = new Template.Constructor.Converted<ItemEntityHandle>();

...
/**
 * Instance wrapper handle for type <b>net.minecraft.world.entity.player.Abilities</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.world.entity.player.Abilities")
public abstract class AbilitiesHandle extends Template.Handle {
    /** @see AbilitiesClass */
    public static final AbilitiesClass T = Template.Class.create(AbilitiesClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.world.entity.player.Abilities</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class AbilitiesClass extends Template.Class<AbilitiesHandle> {
        public final Template.Constructor.Converted<AbilitiesHandle> constr = new Template.Constructor.Converted<AbilitiesHandle>();

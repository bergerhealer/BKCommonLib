...
/**
 * Instance wrapper handle for type <b>net.minecraft.world.entity.vehicle.minecart.MinecartFurnace</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.InstanceType("net.minecraft.world.entity.vehicle.minecart.MinecartFurnace")
public abstract class MinecartFurnaceHandle extends AbstractMinecartHandle {
    /** @see MinecartFurnaceClass */
    public static final MinecartFurnaceClass T = Template.Class.create(MinecartFurnaceClass.class, com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);
    /* ============================================================================== */
    ...
    /**
     * Stores class members for <b>net.minecraft.world.entity.vehicle.minecart.MinecartFurnace</b>.
     * Methods, fields, and constructors can be used without using Handle Objects.
     */
    public static final class MinecartFurnaceClass extends Template.Class<MinecartFurnaceHandle> {
        @Template.Optional

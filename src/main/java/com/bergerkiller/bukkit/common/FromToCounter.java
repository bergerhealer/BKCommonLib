...
/**
 * A simple Integer iterator that counts from one value to the other. Allows
 * both positive and negative iteration.
 */
public class FromToCounter {
    ...
    /**
     * Constructs a new FromToCounter counting from the start to the end
     * specified
     *
    ...
    /**
     * Resets this counter to start counting again from the original start and
     * end values
     */
    public void reset() {
        this.i = this.start;

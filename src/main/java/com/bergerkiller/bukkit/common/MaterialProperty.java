...
public abstract class MaterialProperty<T> {
    ...
    private static final SafeMethod<Object> getMethodA = new SafeMethod<>(MaterialProperty.class, "get", int.class);
    private static final SafeMethod<Object> getMethodB = new SafeMethod<>(MaterialProperty.class, "get", Material.class);
     ...
     * @return The property of the material
     */
    public T get(Chunk chunk, BlockPosition blockposition) {
        return get(ChunkUtil.getBlockType(chunk, blockposition));
    }
     ...
     * @return The property of the material
     */
    public T get(org.bukkit.World world, BlockPosition blockposition) {
        return get(WorldUtil.getBlockType(world, blockposition));
    }

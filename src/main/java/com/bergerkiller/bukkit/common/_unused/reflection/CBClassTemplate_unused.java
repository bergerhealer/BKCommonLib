 ...
 * Class name
 */
public class CBClassTemplate_unused extends ClassTemplate<Object> {

    /**
     * Initializes this CB Class Template using the CB Class name the same as
     * this Class<br>
     * If this Class is called 'CraftServer', it will point to Class
     ...
     * Class
     */
    protected CBClassTemplate_unused() {
     ...
     */
    public CBClassTemplate_unused(String className) {
    ...
    protected ClassTemplate<Object> setCBClass(String className) {
    ...
    /**
     * Creates a new CB Class Template for the org.bukkit.craftbukkit Class name
     * specified
     *
     * @param name of the class in the CB package
     * @return new Class Template
     */
    public static CBClassTemplate_unused create(String name) {
        return new CBClassTemplate_unused(name);
    }
}

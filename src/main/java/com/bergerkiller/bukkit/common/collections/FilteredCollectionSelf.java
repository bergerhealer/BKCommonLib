 ...
 * allows for quick-and-dirty Filtered Collections that don't require the
 * creation of new Filter instances.
 *
...
public abstract class FilteredCollectionSelf<E> extends FilteredCollection<E> implements Filter<E> {
    ...
    /**
     * Constructs a new Self-Filtered Collection using the base Collection
     * specified
     *

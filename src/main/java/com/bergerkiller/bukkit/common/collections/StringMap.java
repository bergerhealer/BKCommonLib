...
public class StringMap<V> extends HashMap<String, V> {
    ...
    /**
     * Returns true if this map contains a mapping for the specified key. The
     * lower case version of the key is tested against. Null keys are supported.
     *
    ...
    /**
     * Returns true if this map contains a mapping for the specified key. The
     * upper case version of the key is tested against. Null keys are supported.
     *
     * @param key to test against
     * @return True if the map contains the key, False if not
     */
    ...
    /**
     * Removes the mapping for the specified key from this map if present. The
     * value mapped to the lower case value of the key is removed. Null keys are
     * supported.
     *
     * @param key to remove
    ...
    /**
     * Removes the mapping for the specified key from this map if present. The
     * value mapped to the upper case value of the key is removed. Null keys are
     * supported.
     *
     * @param key to remove
     * @return the removed value, or null if not found
     ...
     * map contains no mapping for the key. The value is mapped to the lower
     * case value of the key is returned. Null keys are supported.
     *
    ...
    /**
     * Returns the value to which the specified key is mapped, or null if this
     * map contains no mapping for the key. The value is mapped to the upper
     * case value of the key is returned. Null keys are supported.
     *
     * @param key to get the value of
     * @return the value, or null if not contained
     ...
     * replaced. The value is mapped to the lower case value of the key. Null
     * keys are supported.
     *
     ...
     * Associates the specified value with the specified key in this map. If the
     * map previously contained a mapping for the key, the old value is
     * replaced. The value is mapped to the upper case value of the key. Null
     * keys are supported.
     *
     * @param key to put the value at
     * @param value to put

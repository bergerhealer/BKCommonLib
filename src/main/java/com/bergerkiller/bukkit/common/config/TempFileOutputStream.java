...
public class TempFileOutputStream extends OutputStream {
    ...
    /**
     * Constructs a new TempFileOutputStream with the output file specified. The
     * temporary file is the output file with <i>.tmp</i> appended.
     *
    ...
    /**
     * Constructs a new TempFileOutputStream with the output file and temporary
     * file specified.
     *
    ...
    /**
     * Constructs a new TempFileOutputStream with the output file, temporary
     * file and temporary base stream specified. The temporary base stream
     * should be a {@link FileOutputStream} pointing to the
    ...
    /**
     * Closes the temporary file stream, writing any pending data to it. If
     * completeTransfer is set, the output file is replaced with the temporary
     * file. Typically, this parameter should specify whether previous writing
     * was successful.
     *
     * @param completeTransfer - True to replace the output file, False to
     * preserve it

...
public class Conversion {
    ...
    public static final InputConverter<Object> toEntityPlayerHandle = getConverterToHandle("net.minecraft.server.level.ServerPlayer");
    public static final InputConverter<Object> toWorldHandle = getConverterToHandle("net.minecraft.world.level.Level");
    public static final InputConverter<Object> toChunkHandle = getConverterToHandle("net.minecraft.world.level.chunk.LevelChunk");
    ...
    public static final InputConverter<Object> toTileEntityHandle = getConverterToHandle("net.minecraft.world.level.block.entity.BlockEntity");
    ...
    public static final InputConverter<Object> toDifficultyHandle = getConverterToHandle("net.minecraft.world.Difficulty");
    public static final InputConverter<Object> toPacketHandle = getConverterToHandle("net.minecraft.network.protocol.Packet");
    public static final InputConverter<Object> toVec3DHandle = getConverterToHandle("net.minecraft.world.phys.Vec3");
    public static final InputConverter<Object> toChunkCoordIntPairHandle = getConverterToHandle("net.minecraft.world.level.ChunkPos");
    public static final InputConverter<Object> toBlockPositionHandle = getConverterToHandle("net.minecraft.core.BlockPos");
    public static final InputConverter<Object> toPlayerAbilitiesHandle = getConverterToHandle("net.minecraft.world.entity.player.Abilities");
    ...
    public static final InputConverter<Object> toMobEffect = getConverterToHandle("net.minecraft.world.effect.MobEffectInstance");
    public static final InputConverter<Object> toMapIconHandle = getConverterToHandle("net.minecraft.world.level.saveddata.maps.MapDecoration");
    public static final InputConverter<Object> toChatComponentHandle = getConverterToHandle("net.minecraft.network.chat.Component");
    public static final InputConverter<Object> toEnumItemSlotHandle = getConverterToHandle("net.minecraft.world.entity.EquipmentSlot");
    // Wrappers

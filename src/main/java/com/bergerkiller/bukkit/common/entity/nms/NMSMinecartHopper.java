...
import net.minecraft.server.v1_5_R1.EntityMinecartHopper;
import net.minecraft.server.v1_5_R1.ItemStack;
import net.minecraft.server.v1_5_R1.NBTTagCompound;
import net.minecraft.server.v1_5_R1.World;

@SuppressWarnings("rawtypes")
public class NMSMinecartHopper extends EntityMinecartHopper implements NMSEntityInventoryHook {
	...
	public NMSMinecartHopper(World world) {
		super(world);
	}

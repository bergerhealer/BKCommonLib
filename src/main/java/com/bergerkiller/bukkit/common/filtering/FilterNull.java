...
/**
 * A filter that performs a simple NULL-Check on each element. If the element is
 * null, True is returned indicating that it should be filtered.
 *
...
public class FilterNull<E> implements Filter<E> {
    ...
    /**
     * An instance of a NULL-Filter that can be used directly. The
     * implementation of a NULL-Filter does not depend on the element type.
     */

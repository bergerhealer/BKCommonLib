...
/**
 * Filters all elements that are not an instance of a certain type. The
 * {@link #getFilteredType()} can be overridden to allow a dynamic type.
 *
...
public class FilterType<E> implements Filter<E> {
    ...
    /**
     * Gets the Class type that is being filtered. Elements not of this type are
     * filtered.
     *

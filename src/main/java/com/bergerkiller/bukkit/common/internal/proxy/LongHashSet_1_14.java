...
/**
 * Bukkit developers dropped the LongHashSet from CraftBukkit in 1.14.
 * We need it ourselves. So here is a copy that is only used on 1.14 and later.
 * May be worth using a proper library for this in the future.
 */
public class LongHashSet_1_14 {
    ...
    public LongHashSet_1_14() {
        this(INITIAL_SIZE);
    }

    public LongHashSet_1_14(int size) {
    ...
    public boolean contains(int msw, int lsw) {
        return contains(MathUtil.toLong(msw, lsw));
    }
    ...
    public boolean add(int msw, int lsw) {
        return add(MathUtil.toLong(msw, lsw));
    }
    ...
    public void remove(int msw, int lsw) {
        remove(MathUtil.toLong(msw, lsw));
    }

...
public class AsyncTextWriter_nio {
    ...
    private static abstract class AsyncTestWriterStepWriter extends AsyncTextWriterStep<Integer> {
         ...
         * @param writer
         */
        protected abstract void next(AsyncTextWriter_nio writer);
    ...
    private static abstract class AsyncTextWriterStep<T> implements CompletionHandler<T, AsyncTextWriter_nio> {
        /**
         * Starts this writer step
         * 
         * @param writer
         */
        public abstract void start(AsyncTextWriter_nio writer);

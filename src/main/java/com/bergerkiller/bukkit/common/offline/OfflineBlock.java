...
public final class OfflineBlock {
    ...
    /**
     * Gets an OfflineBlock relative to this block, by adding the delta
     * x/y/z coordinates to the current coordinates of this OfflineBlock.
     *
     * @param dx Amount to add to the X-coordinate of this OfflineBlock
     * @param dy Amount to add to the Y-coordinate of this OfflineBlock
     * @param dz Amount to add to the Z-coordinate of this OfflineBlock
     * @return OfflineBlock
     */
    ...
    /**
     * Gets an OfflineBlock relative to this block, by adding offsetting
     * the Block by one into a BlockFace direction.
     *
     * @param face Direction to offset this OfflineBlock
     * @return OfflineBlock
     */

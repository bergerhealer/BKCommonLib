...
public class CraftInventoryProxy extends CraftInventory implements Proxy<Inventory> {
    ...
    public Location super_getLocation() {
    ...
    public ItemStack[] super_getStorageContents() {
        return super.getStorageContents();
    }
    ...
    public void super_setStorageContents(ItemStack[] items) {

 ...
 * For example, you can make a Proxy of a List so it will alter elements in
 * another List instance than itself.
 *
...
public class ProxyBase<T> implements Proxy<T> {
    ...
    /**
     * If the object is a Proxy class, it's base is unwrapped and returned
     * instead
     *
    ...
    /**
     * Validates that all methods are properly overrided. Logs a warning if this
     * is not the case.
     *

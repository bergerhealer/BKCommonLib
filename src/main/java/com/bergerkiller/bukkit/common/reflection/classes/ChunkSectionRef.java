...
public class ChunkSectionRef {
    ...
    private static final MethodAccessor<Block> setData = TEMPLATE.getMethod("b", int.class, int.class, int.class);
    ...
    public static IBlockData getType(Object section, int x, int y, int z) {

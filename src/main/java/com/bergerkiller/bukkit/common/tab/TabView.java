 ...
 * instances at runtime, call {@link #clone()} or
 * {@link #cloneResize(int, int)}. Pay close attention to the Java Docs of these
 * methods!
 */
public abstract class TabView {
    ...
    /**
     * A ping value constant that represents the default ping value, which is
     * equal to {@link #PING_1}
     */
    public static final int PING_DEFAULT = PING_1;
    /**
     * A text value constant that represents the default 'no text', which shows
     * empty (no) text
     */
    public static final String TEXT_DEFAULT = "";
    /**
     * A TabView constant that denotes the default view, that is, the player
     * names and their ping
     */
    public static final TabView DEFAULT = new TabViewDefault();
    /**
     * A TabView constant that denotes an empty view, where all available slots
     * are cleared
     */
    ...
    /**
     * Gets the total amount of slots of this Tab View. This is equal to [width
     * x height]
     *
    ...
    /**
     * Sets all the text and ping values of a single column. Points outside of
     * the text or ping array bounds are ignored. If the text or ping arrays are
     * null, the values are ignored. The text is set from top to bottom
     *
     ...
     * Sets all the text and ping values of a single row. Points outside of the
     * text or ping array bounds are ignored. If the text or ping arrays are
     * null, the values are ignored. The text is set from left to right
     *
    ...
    /**
     * Sets all text and ping values in the area to the text and ping values
     * specified. Ordering of xy1 and xy2 is not important.
     *
     * @param x1 - x-coordinate of point 1 (inclusive)
     * @param y1 - y-coordinate of point 1 (inclusive)
     * @param x2 - x-coordinate of point 2 (inclusive)
    ...
    /**
     * Sets all the contents of this Tab View to contain the contents of the Tab
     * View. If the Tab View is larger than this one, only a portion that can
     * fit in this Tab View is transferred over.
     *
    ...
    /**
     * Displays this Tab View to the player specified. The player is added to
     * the viewers, previous viewers are not removed. If you wish to hide this
     * Tab View again, use displayTo on the {@link #DEFAULT} or {@link #EMPTY}
     * constants.
     *
     * @param player
     */
    ...
    /**
     * Displays this Tab View to all online players and all players that will
     * join in the future.
     */
    ...
    /**
     * Creates a new clone of this TabView that is of a smaller size than this
     * one.
     *
    ...
    /**
     * Creates a new Tab View that is a sub-area of this Tab View. Any changes
     * made to this returned Tab View operate on this original Tab View.
     *
     ...
     * @throws IndexOutOfBoundsException if the area specified is not a sub-area
     * of this one
     */
     ...
     * defining the maximum tab size you expect to need when enabling.
     *

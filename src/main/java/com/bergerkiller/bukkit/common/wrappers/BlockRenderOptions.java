 ...
 */
public final class BlockRenderOptions implements Map<String, String>, Cloneable {
    ...
    public final int hashCode() {
        return this.blockData.hashCode() + (this.map(false).hashCode() >> 10);
    }

    @Override
    public final boolean equals(Object o) {
        if (o instanceof BlockRenderOptions) {
            BlockRenderOptions options = (BlockRenderOptions) o;
            return options.blockData.equals(this.blockData) &&
                    options.map(false).equals(this.map(false));
        } else {
            return false;
        }
    }
    ...
    public final String toString() {
        return this.blockData.getBlockName() + "[" + this.getOptionsString() + "]";
    }

    @Override
    public final BlockRenderOptions clone() {
        if (this.optionsMap != null) {

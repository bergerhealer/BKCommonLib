...
/**
 * Instance wrapper handle for type <b>net.minecraft.network.protocol.game.PacketPlayOutBoss</b>.
 * To access members without creating a handle type, use the static {@link #T} member.
 * New handles can be created from raw instances using {@link #createHandle(Object)}.
 */
@Template.Optional
@Template.InstanceType("net.minecraft.network.protocol.game.PacketPlayOutBoss")
public abstract class PacketPlayOutBossHandle extends PacketHandle {
    ...
    /**
     * Stores class members for <b>net.minecraft.network.protocol.game.PacketPlayOutBoss</b>.

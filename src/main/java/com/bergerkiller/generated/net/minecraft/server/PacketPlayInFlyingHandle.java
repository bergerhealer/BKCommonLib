...
public abstract class PacketPlayInFlyingHandle extends PacketHandle {
    ...
    public static final PacketPlayInFlyingClass T = new PacketPlayInFlyingClass();
    static final StaticInitHelper _init_helper = new StaticInitHelper(PacketPlayInFlyingHandle.class, "net.minecraft.server.PacketPlayInFlying", com.bergerkiller.bukkit.common.Common.TEMPLATE_RESOLVER);

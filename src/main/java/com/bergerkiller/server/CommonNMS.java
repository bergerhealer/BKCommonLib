...
public class CommonNMS {
    ...
    public static void applyPhysics(World world, int x, int y, int z, Block matBlock) {
    	//TODO: BROKEN!!!
    	return;
    	//world.applyPhysics(new BlockPosition(x, y, z), matBlock);
    }
    ...
    public static TileEntity getNative(org.bukkit.block.BlockState blockState) {
        return (TileEntity) CBCraftBlockState.toTileEntity(blockState);
    }

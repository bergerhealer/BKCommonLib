...
public class TemplateTest {
    ...
    @Test
    public void revealMojangName() {
        String spigotClassName = "net.minecraft.core.BlockPosition";
        ...
        System.out.println("MOJANG: " + SpigotMappings.fromCacheOrDownload(CommonBootstrap.initCommonServer().getMinecraftVersion()).toMojang(spigotClassName));
    }
